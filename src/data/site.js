...
export const origins = [
  {
    ...
    altitude: "1,300 - 1,750 MASL depending on variety and lot.",
    varieties: ["Mix", "Java", "Orange Bourbon"],
  ...
  },
  {
    ...
    varieties: ["Gayo 1", "Gayo 2"],
    processes: ["full-washed", "semi-washed", "honey", "natural", "natural-anaerobic", "wine"],
    profile:
...
export const processingMethods = [
  ...
  },
  {
    ...
    profile:
      "Honey lots can bridge clean washed structure and natural sweetness. Final profile depends on lot handling, drying, and sample evaluation.",
  },
  {
    slug: "semi-washed",
    name: "Semi-Washed",
...
export const products = [
  {
    ...
    name: "Java Ijen Arabica Full Washed Grade 1",
    originSlug: "java-ijen",
    origin: "Java Ijen",
    processSlug: "full-washed",
    process: "Full Washed/Dry Hulled (soaking 8 hours)",
    grade: "Grade 1",
    image: "/images/full-wash.webp",
    status: "By request",
    sampleAvailability: "Available by request",
    shortDescription:
      "Grade 1 Java Ijen Arabica full washed lot for roasters and importers seeking clean, consistent Indonesian green coffee.",
    description:
      "Java Ijen Arabica Full Washed Grade 1 is prepared through full washed and dry hulled processing with an 8-hour soaking stage. It is offered for buyers who require clear technical specifications, stable moisture targets, and export-ready Arabica from East Java.",
    specs: {
      type: "Arabica",
      variety: "Mix",
      ...
      screenSize: "No. 16 - No. 18",
      annualCapacity: "80-100 MT/year",
      packaging: "Export packaging options discussed per quotation",
    },
  },
  {
    slug: "java-ijen-semi-wash-grade-1",
    name: "Java Ijen Arabica Semi Washed Grade 1",
    originSlug: "java-ijen",
    origin: "Java Ijen",
    ...
    sampleAvailability: "Available by request",
    shortDescription:
      "Grade 1 Java Ijen Arabica semi washed lot with wet hulled character and export-oriented specifications.",
    description:
      "Java Ijen Arabica Semi Washed Grade 1 is prepared through a wet hulled process for buyers looking for Indonesian Arabica character, clear lot specification, and dependable commercial supply from East Java.",
    specs: {
      type: "Arabica",
      variety: "Mix",
      altitude: "1,300 - 1,500 MASL",
  ...
  },
  {
    ...
    name: "Java Ijen Arabica Honey Grade 1",
    originSlug: "java-ijen",
    origin: "Java Ijen",
    processSlug: "honey",
    process: "Honey",
    ...
    sampleAvailability: "Available by request",
    shortDescription:
      "Grade 1 Java Ijen Arabica honey process lot with balanced sweetness and buyer-ready specifications.",
    description:
      "Java Ijen Arabica Honey Grade 1 is offered for roasters and importers that want a process profile between washed clarity and natural sweetness. Final suitability should be confirmed through sample evaluation and current lot availability.",
    specs: {
      type: "Arabica",
      variety: "Mix",
      altitude: "1,300 - 1,500 MASL",
      ...
      moistureContent: "Max. 12%",
      screenSize: "No. 16 - No. 18",
      annualCapacity: "40-80 MT/year",
      packaging: "Export packaging options discussed per quotation",
    },
  },
  {
    slug: "java-ijen-natural-classic-grade-1",
    name: "Java Ijen Arabica Natural Grade 1",
    originSlug: "java-ijen",
    origin: "Java Ijen",
    processSlug: "natural",
    process: "Natural",
    ...
    sampleAvailability: "Available by request",
    shortDescription:
      "Grade 1 Java Ijen Arabica natural process lot for buyers seeking sweetness, body, and fruit-forward character.",
    description:
      "Java Ijen Arabica Natural Grade 1 is dried as a natural process lot and positioned for buyers that require defined green coffee specifications before quotation. Cup profile, availability, and allocation are confirmed through sample and commercial discussion.",
    specs: {
      type: "Arabica",
      variety: "Mix",
      altitude: "1,300 - 1,500 MASL",
      ...
      moistureContent: "Max. 12%",
      screenSize: "No. 16 - No. 18",
      annualCapacity: "100-200 MT/year",
      packaging: "Export packaging options discussed per quotation",
    },
  },
  {
    slug: "java-ijen-natural-anaerobic-specialty",
    name: "Java Ijen Arabica Natural Anaerob Specialty",
    originSlug: "java-ijen",
    origin: "Java Ijen",
    ...
    description:
      "Java Ijen Arabica Natural Anaerob Specialty is prepared for specialty-focused buyers seeking a differentiated Indonesian Arabica lot. Availability is limited and should be confirmed by current crop, sample, and allocation.",
    specs: {
      type: "Arabica",
      variety: "Mix",
      altitude: "1,300 - 1,500 MASL",
      ...
      moistureContent: "Max. 12%",
      screenSize: "No. 16 - No. 18",
      monthlyCapacity: "20-40 MT/month",
      packaging: "Export packaging options discussed per quotation",
    },
  },
  {
    slug: "single-variety-java-natural-anaerobic-specialty",
    name: "Java Ijen Java Natural Anaerob Specialty",
    originSlug: "java-ijen",
    origin: "Java Ijen",
    processSlug: "natural-anaerobic",
    process: "Java Natural Anaerob",
    grade: "Specialty",
    image: "/images/Java-Natural-Anaerob.webp",
    status: "Limited",
    sampleAvailability: "Available by request",
    shortDescription:
      "Specialty Java Ijen Arabica from Java variety with natural anaerob processing and limited monthly capacity.",
    description:
      "Java Ijen Java Natural Anaerob Specialty is a limited specialty lot using Java variety from higher altitude Java Ijen areas. It is intended for roasters and specialty programs that require a distinctive Indonesian anaerob offering.",
    specs: {
      type: "Arabica",
      variety: "Java",
      ...
      moistureContent: "Max. 12%",
      screenSize: "No. 16 - No. 18",
      monthlyCapacity: "20 MT/month",
      packaging: "Export packaging options discussed per quotation",
    },
  },
  {
    slug: "orange-bourbon-natural-anaerobic-specialty",
    name: "Java Ijen Orange Bourbon Natural Anaerob Specialty",
    originSlug: "java-ijen",
    origin: "Java Ijen",
    processSlug: "natural-anaerobic",
    process: "Orange Bourbon Natural Anaerob",
    grade: "Specialty",
    ...
    description:
      "Java Ijen Orange Bourbon Natural Anaerob Specialty is a limited specialty Arabica lot from Orange Bourbon variety grown at higher altitude. It is positioned for differentiated roasting programs and should be confirmed through sample evaluation.",
    specs: {
      type: "Arabica",
  ...
  },
  {
    ...
    name: "Aceh Gayo Arabica Full Washed Grade 1",
    originSlug: "aceh-gayo",
    origin: "Aceh Gayo",
    processSlug: "full-washed",
    process: "Full Washed/Dry Hulled (soaking 48 hours)",
    grade: "Grade 1",
    image: "/images/gayo-fullwashed.webp",
    status: "By request",
    sampleAvailability: "Available by request",
    shortDescription:
      "Grade 1 Aceh Gayo Arabica full washed lot with Gayo 1 and Gayo 2 varieties.",
    description:
      "Aceh Gayo Arabica Full Washed Grade 1 is offered for buyers seeking a clean Indonesian Arabica profile from the Gayo highlands, with defined green coffee specifications and monthly availability by request.",
    specs: {
      type: "Arabica",
  ...
  },
  {
    ...
    name: "Aceh Gayo Arabica Semi Washed Grade 1",
    originSlug: "aceh-gayo",
    origin: "Aceh Gayo",
    processSlug: "semi-washed",
    process: "Semi Washed/Wet Hulled",
    ...
    sampleAvailability: "Available by request",
    shortDescription:
      "Grade 1 Aceh Gayo Arabica semi washed lot with wet hulled processing and heavier Indonesian character.",
    description:
      "Aceh Gayo Arabica Semi Washed Grade 1 is prepared through wet hulled processing and offered with clear technical specifications for importers, distributors, and roasters.",
    specs: {
      type: "Arabica",
      variety: "Gayo 1 & Gayo 2",
      altitude: "1,300 - 1,600 MASL",
      defectCount: "3-5%",
      moistureContent: "Max. 14.5%",
      screenSize: "No. 17/18",
      monthlyCapacity: "20 MT/month",
      packaging: "Export packaging options discussed per quotation",
    },
  ...
  {
    slug: "aceh-gayo-honey",
    name: "Aceh Gayo Arabica Honey Grade 1",
    originSlug: "aceh-gayo",
    origin: "Aceh Gayo",
    processSlug: "honey",
    process: "Honey",
    ...
    sampleAvailability: "Available by request",
    shortDescription:
      "Grade 1 Aceh Gayo Arabica honey process lot for buyers seeking sweetness and regional identity.",
    description:
      "Aceh Gayo Arabica Honey Grade 1 is offered as a selected honey process lot from Gayo highland Arabica. Current availability, sample suitability, and commercial allocation should be confirmed before quotation.",
    specs: {
      type: "Arabica",
      variety: "Gayo 1 & Gayo 2",
      altitude: "1,300 - 1,600 MASL",
  ...
  },
  {
    ...
    name: "Aceh Gayo Arabica Natural Grade 1",
    originSlug: "aceh-gayo",
    origin: "Aceh Gayo",
    processSlug: "natural",
    process: "Natural",
    ...
    sampleAvailability: "Available by request",
    shortDescription:
      "Grade 1 Aceh Gayo Arabica natural process lot for single-origin and blend programs.",
    description:
      "Aceh Gayo Arabica Natural Grade 1 is a natural process lot from Gayo highland Arabica, suitable for buyers that want fruit-forward potential with defined commercial specifications.",
    specs: {
      type: "Arabica",
      variety: "Gayo 1 & Gayo 2",
      altitude: "1,300 - 1,600 MASL",
      ...
      moistureContent: "Max. 12%",
      screenSize: "No. 17/18",
      monthlyCapacity: "40-80 MT/month",
      packaging: "Export packaging options discussed per quotation",
    },
  },
  {
    slug: "aceh-gayo-natural-anaerob",
    name: "Aceh Gayo Arabica Natural Anaerob Grade 1",
    originSlug: "aceh-gayo",
    origin: "Aceh Gayo",
    processSlug: "natural-anaerobic",
    process: "Natural Anaerob",
    ...
    sampleAvailability: "Available by request",
    shortDescription:
      "Grade 1 Aceh Gayo Arabica natural anaerob lot for differentiated Indonesian coffee programs.",
    description:
      "Aceh Gayo Arabica Natural Anaerob Grade 1 is a differentiated Gayo lot for buyers seeking a more expressive process profile while keeping clear moisture, screen, defect, and capacity expectations.",
    specs: {
      type: "Arabica",
      variety: "Gayo 1 & Gayo 2",
      altitude: "1,300 - 1,600 MASL",
  ...
  },
  {
    ...
    name: "Aceh Gayo Arabica Wine Grade 1",
    originSlug: "aceh-gayo",
    origin: "Aceh Gayo",
    processSlug: "natural",
    process: "Wine",
    ...
    sampleAvailability: "Available by request",
    shortDescription:
      "Grade 1 Aceh Gayo Arabica wine process lot for differentiated Indonesian coffee offerings.",
    description:
      "Aceh Gayo Arabica Wine Grade 1 offers a differentiated fermented profile from Gayo highland Arabica. Buyers should confirm samples, lot availability, and commercial allocation before purchase.",
    specs: {
      type: "Arabica",
      variety: "Gayo 1 & Gayo 2",
      altitude: "1,300 - 1,600 MASL",
