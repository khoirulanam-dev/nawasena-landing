  ...
  const products = [
    {
      ...
      origin: "Java Ijen",
      desc: "Diproses dengan pencucian penuh (Fully Washed Process). Ceri dikupas, difermentasi, dan dicuci bersih sebelum dijemur. Proses ini menghasilkan profil rasa yang sangat bersih (clean cup), tingkat keasaman (acidity) yang cerah, dan menonjolkan karakter asli premium Arabica.",
      img: "/images/full-wash.jpeg", // Pastikan foto ada di public/images
    },
    {
      id: 2,
      name: "Green Bean Arabica Semi Wash Grade 1",
      origin: "Java Ijen",
      desc: "Diproses dengan metode giling basah (Wet-Hulled). Menghasilkan kopi dengan body yang lebih tebal, acidity yang lebih rendah, serta memunculkan sedikit nuansa rasa rempah dan cokelat yang khas.",
    ...
    },
    {
      ...
      origin: "Java Ijen",
      desc: "Dikeringkan secara utuh bersama kulit cerinya di bawah sinar matahari. Proses alami ini memberikan profil rasa buah-buahan tropis yang manis, aroma yang sangat kuat, dan body yang penuh.",
    ...
    },
    {
      ...
      origin: "Java Ijen",
      desc: "Melalui proses fermentasi di dalam wadah kedap udara (tanpa oksigen). Teknik inovatif ini menciptakan kompleksitas rasa yang luar biasa, sering kali memunculkan notes winey, buah matang, dan sensasi sweet-sour yang unik.",
    ...
    },
    {
      ...
      origin: "Toraja",
      desc: "Kopi legendaris dari dataran tinggi Toraja. Dikenal di seluruh dunia dengan karakter rasanya yang earthy, tingkat keasaman yang seimbang, dan body yang syrupy.",
